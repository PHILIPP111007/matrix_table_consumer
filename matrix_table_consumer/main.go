...
//export Filter
func Filter(include_pointer *C.char, input_vcf_path_pointer *C.char, output_vcf_path_pointer *C.char, is_gzip bool) {
	...
	functions_go.Filter(include, input_vcf_path, output_vcf_path, is_gzip)
}
